...
quality: ## check coding style with pycodestyle and pylint
	...
	pylint edx-filters-pipelines tests test_utils *.py
	rm tests/__init__.py
	pycodestyle edx-filters-pipelines tests  *.py
	pydocstyle edx-filters-pipelines tests *.py
	isort --check-only --diff tests test_utils edx-filters-pipelines *.py test_settings.py
