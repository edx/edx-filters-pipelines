#!/usr/bin/env python
"""
Package metadata for edx-filters-pipelines.
"""
import os
import re
import sys
...
setup(
    name='edx-filters-pipelines',
    version=VERSION,
    description="""A Python package that defines and manages custom filter pipelines for use with edx-filters""",
