...
def get_cached_recaptcha_verifier() -> Optional[RecaptchaVerifier]:
    """Get a cached reCAPTCHA verifier instance """
    return create_recaptcha_verifier()


def verify_recaptcha_token_cached(token: str) -> bool:
    """
    Verify reCAPTCHA token using a cached verifier instance.
    ...
    try:
        ...
        verifier = get_cached_recaptcha_verifier()
