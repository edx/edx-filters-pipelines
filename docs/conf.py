...
"""
edx-filters-pipelines documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'edx-filters-pipelines',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edx/edx-filters-pipelines",
...
#
# html_title = 'edx-filters-pipelines v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx-filters-pipelines'),
                os.path.join(root_path, 'edx-filters-pipelines/migrations')])
